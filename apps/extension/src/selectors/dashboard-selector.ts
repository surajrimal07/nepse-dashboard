...
export const selectIsDailyChart = (state: DashboardState) =>
	state.chartTypeByIndex[state.activeIndexInDashboard] === "1d";

export const selectToggleChartType = (state: DashboardState): (() => void) =>
	state.toggleChartType;
